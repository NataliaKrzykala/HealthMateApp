...
object BluetoothUUIDs {
    ...
    val UUID_WEIGHT_SCALE_SERVICE: UUID = UUID.fromString("0000181D-0000-1000-8000-00805f9b34fb")
    val UUID_WEIGHT_SCALE_CHARACTERISTIC: UUID = UUID.fromString("00002a9d-0000-1000-8000-00805f9b34fb")
    //val UUID_WEIGHT_SCALE_FEATURE_CHARACTERISTIC: UUID = UUID.fromString("00002a9e-0000-1000-8000-00805f9b34fb")
    ...
    val UUID_GAP_SERVICE: UUID = UUID.fromString("00001800-0000-1000-8000-00805f9b34fb")
    val UUID_PREFERRED_PARAMETERS_CHARACTERISTIC: UUID = UUID.fromString("00002a04-0000-1000-8000-00805f9b34fb")
    ...
    val UUID_DATETIME_SERVICE: UUID = UUID.fromString("00001847-0000-1000-8000-00805f9b34fb")
    val UUID_DATETIME_CHARACTERISTIC: UUID = UUID.fromString("00002A08-0000-1000-8000-00805f9b34fb")
